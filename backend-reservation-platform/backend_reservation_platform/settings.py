"""
Django settings for backend_reservation_platform project.
...
ROOT_URLCONF = 'backend_reservation_platform.urls'
...
WSGI_APPLICATION = 'backend_reservation_platform.wsgi.application'
